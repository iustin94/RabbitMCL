...
namespace RabbitMQWebAPI.Library.Models.Queue.QueueBackingQueue
{
    public class QueueBackingQueueSentinel : Sentinel<QueueBackingQueueStatus, QueueBackingQueueStatusParameters>
    {
        public override QueueBackingQueueStatusParameters ParseDictionaryToParameters(IDictionary<String, Object> parametersDictionary)
        {
            ...
            parameters.mode =  parametersDictionary["mode"] ==null? String.Empty : parametersDictionary["mode"].ToString();
            ...
            parameters.target_ram_count = parametersDictionary["target_ram_count"] == null? String.Empty : parametersDictionary["target_ram_count"].ToString();
