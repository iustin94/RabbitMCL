...
{
    public class ChannelMessageStatsSentinel : Sentinel<ChannelMessageStats, ChannelMessageStatsParameters>
    {
        //God, don't look here pls
        public override ChannelMessageStatsParameters ParseDictionaryToParameters(IDictionary<String, Object> parametersDictionary)
        {
            ChannelMessageStatsParameters parameters = new ChannelMessageStatsParameters();
